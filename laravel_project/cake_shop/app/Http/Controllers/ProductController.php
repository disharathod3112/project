...
//====product===//
   ...
   // $data = product::find($id);
    ...
    public function menu(product $product)
    {
     ...
     return view('website.menu' , compact('categories') , ["product" => $data ]);

    
    }

    public function view_product(product $product,$id)
    {

       $data=$product::find($id);
     return view('website.product_detail' , ["product" => $data]);
    ...
    public function edit(product $product,$id)
    {
        ...
        return view('admin.edit_product', compact('catagories') , ["product" => $data ]);
    }
