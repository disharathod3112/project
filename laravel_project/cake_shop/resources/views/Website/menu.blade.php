                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex h-100">
                                        <div class="flex-shrink-0">
                                            <img class="img-fluid" src="<?php echo ('upload/product/'.$product->image); ?>" alt="" style="width: 150px; height: 85px;">
                                            <h4 class="bg-dark text-primary p-2 m-0">{{ $product->price }}.00</h4>
                                        </div>
                                        <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                            <h5 class="text-uppercase">{{ $product->name }}</h5>
                                            <span> {{ $product->discription }}
                                                <a href="{{ url('/view_product/'.$product->id) }}" class="btn btn-primary">View More</a>
                                            </span>
                                        </div>
                                    </div>
                                </div>
